...
%         case 1; [Ex,Ey,Ez,Hx,Hy,Hz]=mphinterp(model,{'emw.Ex', 'emw.Ey','emw.Ez','emw.Hx','emw.Hy','emw.Hz'},'coord',coord.','Complexout','on');
      	case 'std1_all'
            [Ex,Ey,Ez,Hx,Hy,Hz]=mphinterp(model,{'ewfd.Ex', 'ewfd.Ey','ewfd.Ez','ewfd.Hx','ewfd.Hy','ewfd.Hz'},'coord',coord.','Complexout','on');
...
%         case 0; [Ex,Ey,Ez,Hx,Hy,Hz]=mphinterp(model,{'emw.relEx', 'emw.relEy','emw.relEz','emw.relHx','emw.relHy','emw.relHz'},'coord',coord.','Complexout','on');
      	case 'std1_rel'
            [Ex,Ey,Ez,Hx,Hy,Hz]=mphinterp(model,{'ewfd.relEx', 'ewfd.relEy','ewfd.relEz','ewfd.relHx','ewfd.relHy','ewfd.relHz'},'coord',coord.','Complexout','on');
        case 'std2_rel'
            [Ex,Ey,Ez,Hx,Hy,Hz]=mphinterp(model,{'ewfd2.relEx', 'ewfd2.relEy','ewfd2.relEz','ewfd2.relHx','ewfd2.relHy','ewfd2.relHz'},'coord',coord.','Complexout','on');
    end
